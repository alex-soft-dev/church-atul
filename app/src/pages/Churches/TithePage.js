...
function TithePage({ navigation }) {
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <CustomHeader title={i18n.t('Tithe')} navigation={navigation} />
            ...
            <ScrollView>
                <Image source={require('../../../assets/images/banner/tithe.jpg')} style={{ height: 290, resizeMode: 'stretch' }} />
                <View style={{ paddingHorizontal: 55, paddingVertical: 30 }}>
                    <Text style={{ fontSize: 14, fontWeight: '500', color: 'black', marginBottom: 30 }}> </Text>
                    <View>
                        <Button style={{ height: 40, borderColor: "#FE7940", borderWidth: 1, borderRadius: 50, backgroundColor: 'white', marginBottom: 20 }} textColor="#FE7940" onPress={() => setAmount('2000')}>2000 F CFA</Button>
                        <Button style={{ height: 40, borderColor: "#FE7940", borderWidth: 1, borderRadius: 50, backgroundColor: 'white', marginBottom: 20 }} textColor="#FE7940" onPress={() => setAmount('10000')}>10000 F CFA</Button>
                        <Button style={{ height: 40, borderColor: "#FE7940", borderWidth: 1, borderRadius: 50, backgroundColor: 'white', marginBottom: 20 }} textColor="#FE7940" onPress={() => setAmount('50000')}>50000 F CFA</Button>
                        <TextInput
                            style={{ height: 40, borderColor: "#FE7940", borderBottomWidth: 1, borderRadius: 5, backgroundColor: 'white', marginBottom: 20, textAlign: 'center', color: '#FE7940' }}
            ...
            <Portal>
                <Modal visible={visible} onDismiss={hideModal} contentContainerStyle={{ width: "90%", justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', padding: 30, borderRadius: 30, marginRight: 'auto', marginLeft: 'auto' }}>
                    <Button style={{ height: 40, borderColor: "#FE7940", borderWidth: 1, borderRadius: 50, backgroundColor: '#FE7940', marginTop: 30, width: '90%' }} textColor="white" onPress={hideModal}>Donate</Button>
                </Modal>
            </Portal>
            {isLoading && <Preloader />}
        </SafeAreaView>
